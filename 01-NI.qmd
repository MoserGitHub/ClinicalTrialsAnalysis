...
bap <- integrate(function(x) (x)^(a_0+n_0*p_0-1)*(1-x)^(b_0+n_0-n_0*p_0-1)*pbeta(x-delta_star, a_1+n_1*p_1, b_1+n_1-n_1*p_1), lower = delta_star, upper = 1)[[1]]*(1/beta(a_0+n_0*p_0, b_0+n_0-n_0*p_0))
