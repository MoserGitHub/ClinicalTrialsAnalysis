...
\end{aligned}
$$
is the **Bayesian probability to reject** given assumed $r_0, r_1, n_0, n_1$. Note that the last term in the above formula is the upper tail of a beta-binomial cdf. Grieve highlights that this is can be written as a hypergeometric distribution (@Grieve2022, @Grieve2016).
