...
$$
where the left side of the above equation is the if the upper $(1-\epsilon)$-credible interval. A simple algebraic step gives
$$
\begin{aligned}
...
where the last term in the above formula is the upper tail of a beta-binomial distribution. Altham @Altham1969 showed that this could also be written as a hypergeometric distribution (see also @Grieve2022, @Grieve2016).
