...
data_bap <- data.frame(pred_1 = r_1/m, pred_0 = r_0/m,
    diff = r_1/m - r_0/m, type = "Enthusiastic")

data_bap_graph <- data_bap

bap <- sum(ifelse(data_bap$diff + qnorm(1 - alpha) *
    sqrt(var_posterior_0 + var_posterior_1)/m <= delta_star,
    1, 0))/q
...
data_bap <- data.frame(pred_1 = r_1/m,
    pred_0 = r_0/m, diff = r_1/m - r_0/m, type = "Skeptical")
...
data_bap <- data.frame(pred_1 = r_1/m,
    pred_0 = r_0/m, diff = r_1/m - r_0/m, type = "Informative")
...
data_bap <- data.frame(pred_1 = r_1/m,
    pred_0 = r_0/m, diff = r_1/m - r_0/m, type = "Noninformative")
