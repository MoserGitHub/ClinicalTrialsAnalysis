...
&=\int_{-\delta^*}^{1-\delta^*}\frac{(\pi_0-\delta^*)^{a_0+r_0-1}(1-\pi_0+\delta^*)^{b_0+n_0-r_0-1}}{B(a_0+r_0, b_0+n_0-r_0)}\left(\int_0^{\pi_0} \frac{\pi_1^{a_1+r_1-1}(1-\pi_1)^{b_1+n_1-r_1-1}}{B(a_1+r_1, b_1+n_1-r_1)}d\pi_1\right)d\pi_0 \\
\end{aligned}
$$
...
&=\int_{\delta^*}^{1+\delta^*}\frac{(\pi_0+\delta^*)^{a_0+r_0-1}(1-\pi_0-\delta^*)^{b_0+n_0-r_0-1}}{B(a_0+r_0, b_0+n_0-r_0)}\left(\sum_{s=a_1+r_1}^{a_1+b_1+n_1-1}\begin{pmatrix} a_1+b_1+n_1-1 \\ s \end{pmatrix}(\pi_0+\delta^*)^s(1-\pi_0-\delta^*)^{a_1+b_1+n_1-2-s}\right)d\pi_0 \\
&=\sum_{s=a_1+r_1}^{a_1+b_1+n_1-1}\frac{(\pi_0+\delta^*)^{a_0+r_0-1}(1-\pi_0-\delta^*)^{b_0+n_0-r_0-1}}{B(a_0+r_0, b_0+n_0-r_0)}\left(\begin{pmatrix} a_1+b_1+n_1-1 \\ s \end{pmatrix}\int_{\delta^*}^{1+\delta^*}(\pi_0+\delta^*)^s(1-\pi_0-\delta^*)^{a_1+b_1+n_1-2-s}d\pi_0\right)
\end{aligned}
$$
...
inner_int <- Vectorize(function(y) {
    (y-delta_star)^(a_0 + ceiling(n_0) * p_0 - 1) * (1 - y + delta_star)^(b_0 +
...
b_0 <- (1 - 0.03)/(0.03) * a_0
delta_star <- 0.035
bap <- integrate(inner_int, delta_star, 1+delta_star)$value/(beta(a_1 +
