...
m <- 100
set.seed(1)
r_1 <- rbbinom(q, size = m, a_1 + ceiling(n_1) * p_1,
    b_1 + ceiling(n_1) - ceiling(n_1) * p_1)
mean_r_1 <- m * (a_1 + ceiling(n_1) * p_1)/(a_1 + ceiling(n_1) *
    p_1 + b_1 + ceiling(n_1) - ceiling(n_1) * p_1)
var_posterior_1 <- (m * (a_1 + ceiling(n_1) * p_1) *
    (b_1 + ceiling(n_1) - ceiling(n_1) * p_1) * (m +
...
r_0 <- rbbinom(q, size = m, a_0 + ceiling(n_0) * p_0,
    b_0 + ceiling(n_0) - ceiling(n_0) * p_0)
mean_r_0 <- m * (a_0 + ceiling(n_0) * p_0)/(a_0 + ceiling(n_0) *
    p_0 + b_0 + ceiling(n_0) - ceiling(n_0) * p_0)
var_posterior_0 <- (m * (a_0 + ceiling(n_0) * p_0) *
    (b_0 + ceiling(n_0) - ceiling(n_0) * p_0) * (m +
